        ...
        <footer className="max-xontainer">
            ...
            gap-20 flex-wrap max-lg:flex-col">
                <div className="flex flex-col items-start ">
                    <a href="/">
                        <img src={footerLogo} alt="Logo_footer"
                            width={150} height={46} />
                    </a>
                    <p className="mt-6 text-base leading-7  text-white-400
                    sm:max-w-sm">
                        Prepara tus zapatillas para el nuevo semestre en tu tienda Nike más cercana.
                        Encuentra tu talla perfecta en la tienda. Obtener recompensas
                    </p>
                    <div className="flex items-center gap-5 mt-8">
                        {socialMedia.map((icon) => (
                            <div key={icon.alt} className="flex justify-center items-center w-12 h-12 bg-white
                            rounded-full ">
                                <img
                                    src={icon.src}
                                    alt={icon.alt}
            ...
            max-sm:items-center">
                ...
                font-montserrat cursor-pointer">
                    ...
                    />
                    <p>Derechos de autor. Reservados todos los derechos. Renzo dev</p>
                </div>
                 <p className="font-monstserrat cursor-pointer">Terminos y condiones</p>                   
            </div>
        </footer>
    );
}
